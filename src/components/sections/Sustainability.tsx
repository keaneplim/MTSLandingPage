...
export default function Sustainability() {
  return (
    <section id="sustainability" className="relative py-16 md:py-24 bg-brand-blue-deep overflow-hidden">
      {/* Decorative background element */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-brand-blue-action/10 skew-x-12 translate-x-1/4 hidden lg:block" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              Growing Responsibly for the <br className="hidden sm:block" />
              <span className="text-brand-blue-light">Future of Indonesia</span>
            </motion.h2>
            
            <div className="space-y-6 md:space-y-8">
              <div className="flex gap-4 md:gap-6">
                <div className="shrink-0 w-10 h-10 md:w-12 md:h-12 bg-white/10 rounded-full flex items-center justify-center text-brand-blue-action">
                  <Leaf size={20} className="md:w-6 md:h-6" />
                </div>
                <div>
                  <h4 className="text-white font-bold text-base md:text-lg mb-1 md:mb-2">Environmental Protection</h4>
                  <p className="text-brand-blue-light/70 text-xs md:text-sm leading-relaxed">
          ...
          >
            ...
            {/* Stat Badge */}
            <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white p-6 md:p-8 rounded-lg shadow-xl max-w-[180px] md:max-w-[240px]">
              <p className="text-brand-blue-deep font-black text-3xl md:text-4xl mb-1">100%</p>
              <p className="text-gray-500 text-[10px] md:text-xs font-bold tracking-widest uppercase">Commitment to Excellence</p>
            </div>
          </motion.div>
        </div>
      </div>
