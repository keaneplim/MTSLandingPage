    ...
    <section className="relative h-screen min-h-[700px] w-full flex items-center overflow-hidden bg-brand-blue-deep">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-block px-4 py-1.5 rounded-full bg-brand-blue-action text-white text-xs font-bold tracking-widest mb-6">
              LEADER IN LOGISTICS & WAREHOUSING
            </span>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
              WE EXIST BECAUSE OF <br />
              <span className="text-brand-blue-action">CUSTOMER CONFIDENCE</span>
            </h1>
            <p className="text-lg md:text-xl text-brand-blue-light mb-10 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-white text-brand-blue-deep font-bold rounded-sm flex items-center justify-center gap-2 hover:bg-brand-blue-light transition-all transform hover:scale-105">
                Explore Our Services <ArrowRight size={20} />
              </button>
              <button className="px-8 py-4 border-2 border-white/30 text-white font-bold rounded-sm hover:bg-white/10 transition-all">
                Get a Quotation
              </button>
            </div>
          </motion.div>
